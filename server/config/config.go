...
func initViper() (Constants, error) {
	...
	if os.Getenv("ENVIRONMENT") == "DOCKER" {
		viper.SetConfigName("midas_docker.config") // Configuration fileName without the .TOML or .YAML extension
	} else {
		viper.SetConfigName("midas.config") // Configuration fileName without the .TOML or .YAML extension
	}
